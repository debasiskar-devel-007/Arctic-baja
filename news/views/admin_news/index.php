...
<div id="main">
    <div id="content">
        <h2 id="pageTitle"> News Listing </h2>
        ...
        <div style="margin-top: 10px;" class="newtable">   
            ...
            <div style="float: right;" class="newform">
                <?php
                    ...
                    'type' => 'primary',
                    'size' => 'small',
                    'url' => $baseUrl.'/news/admin/news/add',
                    ));
                ?>
            </div>
            ...
            <?php
                ...
                $.ajax({
                type: "POST",
                url:baseUrl+"/news/admin/news/deleteall",
                ...
                $.post(baseUrl+\'/news/admin_news/bulkupdate\',
                {values:values,attr:\'news_status\',status:1},function(res){
                bootbox.hideAll();
                bootbox.alert("Your selected News has been successfully activated.");
            ...
            $.fn.yiiGridView.update(grid);
                ...
                $.post(baseUrl+\'/news/admin_news/bulkupdate\',
                {values:values,attr:\'news_status\',status:0},function(res){
                bootbox.hideAll();
                bootbox.alert("Your selected News has been successfully deactivated.");
                $(\'#yw0_c0_all\').attr(\'checked\',false);
                checked.each(function(){
                $(this).attr(\'checked\',false);
                var togClassI=$(this).parent("td").parent("tr").children("#st").children("a").children("i");
    ...
    //'inputclass' => 'span3'
                ...
                'name' => 'news_title',
                'filter' => CHtml::activeTextField($model, 'news_title'),
                'value' => '$data->news_title',
                'id'=>'$data[id]',
                'sortable'=>true,
                'type'=>'html',
                'editable' => array(
                'url' => $this->createUrl('admin/news/EditableSaver'),
                'placement' => 'right',
                'inputclass' => 'span3',
                ...
                'class' => 'bootstrap.widgets.TbEditableColumn',
                'name' => 'news_date',
                'filter' =>CHtml::activeDropDownList($model, 'news_date',$res),
                ...
                'toggleAction'=>'admin/news/toggle',
                'displayText'=>true,
                ...
                'deleteButtonUrl'=>'Yii::app()->controller->createUrl("admin/news/delete", array("id"=>$data->id))', //the control is redirected to role/delete with the id value.
                'updateButtonUrl'=>'yii::app()->controller->createUrl("admin/news/updatedata",array("id"=>$data->id))',
                ),
                ...
                //alert(val);
                $.post(baseUrl+"/news/admin/news/showcontent",{"id":val},function(res){
