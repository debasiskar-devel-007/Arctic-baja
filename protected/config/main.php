...
return array(
	...
	'modules'=>array(
        ...
        'product','user','blog','cms','landing_page_manager','ContactusManager','gallery','aboutus','Contactus',
	...
	'components'=>array(
        ...
        'mail' => array(
            ...
            'transportOptions'=>array(
                ...
                'username'=>'support@azcowtown.com',
                'password'=>'P@ssword1',
                'port'=>80,
                //'encryption'=>'ssl',
            ),
        ...
        // This is for localhost
                ...
                'db'=>array(
                    'connectionString' => 'mysql:host=localhost;dbname=baja',
                    'emulatePrepare' => true,
                    'username' => 'root',
                    'password' => '',
                    'charset' => 'utf8',
        ...
        'db1'=>array(
            'class'=>'CDbConnection',
            'connectionString' => 'mysql:host=23.229.128.104;dbname=influx_db',
            'emulatePrepare' => true,
            'username' => 'developer',
            'password' => 'P@ss1234',
            'charset' => 'utf8',
