...
/*
            ...
            'template' => '{delete} {update} {change_password} <br/> {notes}',   //the bootstrap is modified to remove the view.
            'evaluateID'=>true,
            ...
            'buttons'=>
               ...
               /* 'aff_code'=>array('label'=> 'Grab Affiliate Code','options'=>array('title'=>'Grab Affiliate Code','onclick'=>'grab_aff_code(this)','id'=>'$data->id')),  */
            )
...
<input type="hidden" class="hid" value="<?php echo Yii::app()->getBaseUrl(true);?>" />
    <input class="input-medium aff_link" type="text" readonly="readonly" style="margin: 10px;">

    <a class="button copy-button" href="javascript:void(0);">Copy Home Page URL </a>

    <input class="input-medium aff_link1" type="text" readonly="readonly" style="margin: 10px;">

    <a class="button copy-button1" href="javascript:void(0);">Copy Landing Page URL </a>
