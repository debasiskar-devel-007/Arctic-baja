...
class Admin_userController extends MyController
{
    ...
    public function actionIndex()
    {
     ...
     public function actionListing(){
        ...
        $this->render('index',array('model'=>$model,'roleList'=>$roleList));
    }
    ...
    public function actionUpdate($id)
    {
        ...
        $prevRole = $selRoleList2[0]['role_id'];
        ...
        if(count($_POST)>0)
        {
            ...
            if($result->validate())
            {
                ...
                $roleRel->deleteAllByAttributes(array('user_id'=>@$id));
        ...
        $this->render('edit',array('model'=>$result,'prevRole'=>$prevRole,'roleList'=>$roleList,'countryList'=>$countryList));
    }
