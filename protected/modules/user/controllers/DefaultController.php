...
class DefaultController extends MyController
{
    ...
    public function actionset_affiliate_code($id=0){

        Yii::app()->request->cookies['affliate_code'] = new CHttpCookie('affliate_code', $id,array('expire'=>time()+2592000));
    ...
    //This function to set affiliate code
    public function actionset_affiliate_code1($id=0){

        Yii::app()->request->cookies['affliate_code'] = new CHttpCookie('affliate_code', $id,array('expire'=>time()+2592000));


        $this->redirect(Yii::app()->getBaseUrl(true)."/landing_page_manager");
    }
