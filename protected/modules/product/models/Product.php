...
class Product extends CActiveRecord
{
    ...
    */
    public function rules()
    {
        ...
        array(' productname, productdesc, catagoryid, isactive, productprice, priority,product_type', 'safe', 'on'=>'search'),
        );
    }
    ...
    */
    public function search()
    {
        ...
        $criteria->select = 'cat.categoryname as catagoryid,t.catagoryid as catid,t.productid,t.productname,t.isactive,t.productprice,t.createdon,t.priority,t.product_type as product';
        ...
        $criteria->compare('t.productprice',$this->productprice);
