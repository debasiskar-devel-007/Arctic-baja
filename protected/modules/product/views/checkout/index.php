                    ...
                    foreach($cartdet as $row){
                        ...
                        <tr>
                            <td align="left" valign="top" style="padding-right:10px;">
                                ...
                                <?php if(intval($row['no_color']) > 0){ ?>
                                <br />Choose Color: 
                                <?php } ?>
                                <?php if(intval($row['no_size'])){?>
                                <br />Select Size:  <br />
                                <select class="sizesel" product_id="<?php echo $row['productid'];?>" style="width: auto;">
                                <?php foreach($size_array as $row2){ 
                                    if($row2['product_id'] == $row['productid']) {  ?> 
                                    <option value="<?php echo $row2['price']; ?>" <?php if($cartprice[$row['productid']]['size'] == $row2['size']){ ?> selected="selected" <?php } ?>><?php echo $row2['size']; ?></option>
                                <?php }} ?>
                                </select>
                                <?php }?>
                            </td>
