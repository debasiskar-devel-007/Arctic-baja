    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="border:solid 1px #ddd; background:#fefcfc; padding:10px; font-family:Arial, Helvetica, sans-serif;">
        <tr>
          <td colspan="2" style="font-size:12px; color:#333; "><table width="auto" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td colspan="7" style="background:#0879D1; width:600px; height:20px; padding:5px 10px; font-size:14px; color:#fff">Product List :</td>
              </tr>
              <tr>
                ...
                <td width="50" style="padding:5px; border-bottom:solid 1px #ccc;"><strong>Description</strong></td>
              </tr>
...
?>
              ...
              <tr>
                ...
                <td width="163" style="padding:5px; border-bottom:solid 1px #ccc;"><img src="<?php echo yii::app()->getBaseUrl(true)."/uploads/product_image/thumb/".$row['product_image'] ;?>" /></td>
                ...
                <td width="50" style="padding:5px; border-bottom:solid 1px #ccc;"><?php echo $row['product_desc'];?>
                </td>
              </tr>
              <?php
        }}
