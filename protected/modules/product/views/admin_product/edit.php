...
<div id="main">
    <div id="content">
        ...
        <h2 id="pageTitle">Edit Product</h2>
        ...
        <div class="input-box" style="margin-top:20px;" >
            ...
            <div id="show_thumb" style="margin-left:235px">
                <?php foreach($image as $row){ if (file_exists("./uploads/product_image/thumb/".$row['image_name'])) {?>
                    <div class="imglist" style="position:relative; width:150px; margin-bottom:10px;">
                    <a href="javascript:void(0);">
                    <img name="<?php echo $row['image_name'];?>" src="<?php echo Yii::app()->request->baseUrl;?>/uploads/product_image/thumb/<?php echo $row['image_name'];?>" style="max-height:150px;max-width:150px; border:solid 1px #979797;" /></a><input type="button" class="crop_btn" onclick="crop_image('<?php echo $row['image_name'];?>')" value="Crop"><input type="button" style="margin-left:5px;" class="crop_btn" onclick="del_up_image(this)" value="Delete"><input type="hidden" name="proimage[]" value="<?php echo $row['image_name'];?>" /></div>
                    <?php }}?>
            ...
            ')) ?> 
                   ...
                   <div class="input-box" style="margin-top:20px;" >
           <!-- <label for="profile_pr_image" class="control-label required">downloadable Product</label> -->
            ...
            <div id="nameshow" style="margin-top:20px;margin-left:150px;position:relative"><a href="<?php echo Yii::app()->getBaseUrl(true); ?>/uploads/files/<?php echo $model['file_name'] ?>" target="_blank"><img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/download.png"></a>    </div>  
      ...
      <div class="input-box" style="margin-top:20px;" id="colordiv">
        ...
        <div style="margin-left: 235px;margin-bottom:35px; ">
            ...
            <div id="colorlist" style="margin-top: 10px; width:300px;">
                <?php 
                    if(count($prev_color)){
                        foreach($prev_color as $color){
                ?>
                <div style="height:30px; width:30px; border:#000 1px solid; background-color: #<?php echo $color;?>; margin:5px; float:left; cursor:pointer;" title="Click To Delete This Color" onclick="delcol(this,'<?php echo $color;?>')">&nbsp;</div><input type="hidden" name="color[]" class="colorhid" value="<?php echo $color;?>" />
                <?php }} ?>
        ...
        <?php 
                    if(count($prev_size)){
                        foreach($prev_size as $row){
                ?>
            <div><input type="text" name="size[]" value="<?php echo $row['size'];?>" placeholder="Enter Size">&nbsp;&nbsp;<input type="text" name="size_price[]" value="<?php echo $row['price'];?>" placeholder="Enter Price">&nbsp;&nbsp;<img onclick="addsizediv(this)" src="<?php echo Yii::app()->theme->baseUrl;?>/images/CircledPlus.png" alt="">&nbsp;&nbsp;<img onclick="delsizediv(this)" src="<?php echo Yii::app()->theme->baseUrl;?>/images/CircledMinus.png" alt=""></div>
            <?php }}else{ ?>
