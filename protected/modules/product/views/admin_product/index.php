...
<div id="main">
  ...
  <!--<div class="addbutton" id="refresh" style="margin-bottom:6px; margin-left:12px;"><a href="javascript:void(0)" class="button">Show All</a></div>--> 
        ...
        <?php
            ...
            'type' => 'primary',
            'size' => 'small',
            'url' => Yii::app()->request->baseUrl.'/product/admin/product/add',
            'htmlOptions' => array('style'=>'float:right;class:addbutton')
            ));
        ...
        <?php
           ...
           array(
            ...
            'name' => 'product',
            'filter' =>false,
            'value' => '($data->product == 1)?"Physical":"Downloadable"',
            'id'=>'$data[product]',
            'sortable'=>true,
...
//            'uncheckedIcon'=>false,
            ...
            'template' => '{delete} {update}</br>{d3}',   //the bootstrap is modified to remove the view. 
