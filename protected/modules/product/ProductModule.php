...
class ProductModule extends CWebModule
{
    ...
    protected function registerScript(){
        $js_arr = array('colpick.js','common.js','link.js','jquery.uploadify.min.js','facebox.js','image.upload.js','button.js','marquee.js','flowplayer-3.js'); //put what js file name that you need to import from admin assets folder
