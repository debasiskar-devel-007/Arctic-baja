 ...
 */
class Addicontentinfo extends CActiveRecord
{
    /**
    ...
    public function fetchupdatedetails($id)
    {
        ...
        return $result;*/
        $res=addicontentInfo::model()->findAllByAttributes(array('content_id'=>$id));
        //var_dump($res);
        // exit;
        return $res;
    }
    ...
    {
        Addicontentinfo::model()->deleteAll('content_id ='.$id);
