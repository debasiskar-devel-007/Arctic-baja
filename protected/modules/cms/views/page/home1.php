    ...
    <div class="container">
        ...
        <style>
            .nav-tabs > li.active > a:before{
                ...
                border-color: #<?php echo $this->GetcontentByid(33,$res) ?> transparent transparent #<?php echo $this->GetcontentByid(33,$res) ?>!important;

            }
        </style>
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#home" style="background:#<?php echo $this->GetcontentByid(33,$res) ?>!important;color:#<?php echo $this->GetcontentByid(113,$res) ?>!important" role="tab" data-toggle="tab">General Info</a></li>
            <li><a href="#profile" role="tab" style="background:#<?php echo $this->GetcontentByid(33,$res) ?>!important;color:#<?php echo $this->GetcontentByid(113,$res) ?>!important" data-toggle="tab">IT Services</a></li>
            <li><a href="#messages" style="background:#<?php echo $this->GetcontentByid(33,$res) ?>!important;color:#<?php echo $this->GetcontentByid(113,$res) ?>!important" role="tab" data-toggle="tab">Repair</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="profile">
                ...
                Our professional IT services help you maintain your infrastructure and can be customized to support your unique needs throughout the technology lifecycle.  Secret Simple can provide expert IT support for your growing business. We are qualified and experienced in the IT field and strive for excellence in all our services to ensure your business is always operating at its highest level.
                <?php //echo $this->GetcontentByid(10,$res) ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="div-contain">
                        ...
                        <h2 style="background:#<?php echo $this->GetcontentByid(33,$res) ?>!important;color:#<?php echo $this->GetcontentByid(114,$res) ?>!important"><?php echo $this->GetcontentByid(13,$res)?></h2>
                ...
                <div class="col-md-4">
                    ...
                    <div class="div-contain">
                        ...
                        <h2 style="background:#<?php echo $this->GetcontentByid(32,$res) ?>!important;color:#<?php echo $this->GetcontentByid(114,$res) ?>!important"><?php echo $this->GetcontentByid(16,$res)?></h2>
...
-->
                ...
                <div class="col-md-4">
                    <div class="div-contain">
                        ...
                        <h2 style="background:#<?php echo $this->GetcontentByid(32,$res) ?>!important;;color:#<?php echo $this->GetcontentByid(114,$res) ?>!important"><?php echo $this->GetcontentByid(19,$res)?></h2>
