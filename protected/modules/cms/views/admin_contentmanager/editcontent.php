  ...
  $(document).ready(function(){
      $('#picker').colpick({
          onSubmit:function(hsb,hex,rgb,el) {
              ...
              $(el).colpickHide();
              $('#ContentInfo_content_type').val(hex);
              //alert(hex);
          }
      });
...
<div id="main">
    <div id="content">
        ...
        <?php
            ...
            <span>Upload image with this size <?php echo $model['img_width'] ?> X <?php  echo $model['img_height'] ?>  </span>
    ...
    <?        }
            ...
            echo "WORK IN PROGRESS";                           
                ...
                else if($model['content_type']=='Color Styl')
                {
?>
    <input type="button" id="picker" class="btn" value="Choose Color" />

    <input type="hidden" id="ContentInfo_content_type" name="ContentInfo[content_type]"   class="btn" value="Choose Color" />
