    ...
    <div id="content">
        ...
        <div style="float: right;" class="newform">
            <?php
                ...
                'url' => $baseUrl.'/cms/admin/additionalcontentmanager/add',
                ));
            ?>
        </div>
        ...
        <?php
            ...
            //................for toggle coloum [End]..........
                ...
                'deleteButtonUrl'=>'Yii::app()->controller->createUrl("admin/additionalcontentmanager/delete",array("id"=>$data->id))',
                'updateButtonUrl'=>'yii::app()->controller->createUrl("admin/additionalcontentmanager/update",array("id"=>$data->id))',
                 'buttons'=>array(    
                    'add' => array
                (
                    'label'=>'Manage Content',
                   
                    'url'=>'yii::app()->controller->createUrl("admin/additionalcontentmanager/editcontent",array("id"=>$data->id))',
                    'options'=>array(
                        'class'=>'btn btn-small',
                    ),
                ),
