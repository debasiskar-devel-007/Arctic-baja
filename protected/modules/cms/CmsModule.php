...
{ 
    ...
    protected function registerScript(){
        $js_arr = array('common.js','link.js','jquery.uploadify.min.js','image_upload.js','facebox.js','wow.js','wow.min.js','simply-scroll.js','nbw-parallax.js','jquery-inview.js','responsiveslides.min.js','colpick.js','jquery-ui-block.js'); //put what js file name that you need to import from admin assets folder
