...
class Admin_contentmanagerController extends MyController
{
    ...
    public function actionEditcontent($id)
    {
        ...
        {    
            ...
            else  if($res['content_type']=='Color Styl'){
    ...
    public function actionUploadify_process1()
    {
     ...
     public function actionResizeimage1(){
       ...
       // var_dump($file_name);
        ...
        $foldername = $_POST['foldername'];
         copy(Yii::getPathOfAlias('webroot')."/uploads/content_image/".$file_name,Yii::getPathOfAlias('webroot')."/uploads/content_image/originalsize/".$file_name);
